...
function inputValue(event) {
  ...
  if (remainingCharacLength <= 10) {
    remainingCharac.classList.add("style");
    userMessage.classList.add('style')
  } else {
    remainingCharac.classList.remove("style");
    userMessage.classList.remove('style')
  }
  // while(remainingCharacLength > 10) {
  //   remainingCharac.classList.add("style");
  //     userMessage.classList.add('style')
  // }
}
...
// aside    adding color to a list of items when clicked
